...
enum RouterVersion {
  PlasmaswapRouter = 'PlasmaswapRouter'
}

describe('PlasmaswapRouterTests', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      factory = fixture.factorySwap
      router = {
        [RouterVersion.PlasmaswapRouter]: fixture.routerSwap
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.PlasmaswapRouter]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.PlasmaswapRouter]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
